...
namespace nirvana
{
  namespace message
  {
    namespace canbus
    {
      ...
      *   1       0x256    CDCU_AutoDrvTripMeter     0      1000           Recv   ||
      *==========================================================================**/

      class AutomaticTripStat256 : public CanbusProtocol
      {
      public:
        AutomaticTripStat256()
            : CanbusProtocol(0x256, "CDCU_AutoDrvTripMeter", 0, 1000, MSG_RECV)
        {
        }
