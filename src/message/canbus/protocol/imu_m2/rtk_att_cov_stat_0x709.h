...
namespace nirvana
{
  namespace message
  {
    namespace canbus
    {
      ...
      *   1       0x708    IMU_RtkAttitudeCovStatus      0      20           MSG_RECV   ||
      *============================================================================**/
      class RtkAttitudeCovStat709 : public CanbusProtocol
      {
      public:
        RtkAttitudeCovStat709()
            : CanbusProtocol(0x709, "IMU_RtkAttitudeCovStatus", 0, 20, MSG_RECV)
        {
        }
